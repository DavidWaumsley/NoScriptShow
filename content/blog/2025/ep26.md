...
Google's economic impact report puts advertisers average ROI at 800%. Google's search is so dominant that "Googling" has become a universal verb. Its suite of services (Gmail, Maps, Calendar, Docs) are embedded in our daily life.

- The world's largest advertising platform through Google Search, YouTube and its Display Network.
- Google ads won't give suckers an even break.
- Google supplies free tools because the data support its primary business.
- It's a subsidiary of the profit focused Alphabet, worth over 3 trillion.
- Neil Patel claims that 8 out of 10 businesses lose money on Google Ads.
- Success varies across industries and depends on skill.
- An average ROI can not be expected as there's no normal distribution.

## Traditional vs Digital Marketing

- More traffic won't make a bad offer good.

### No Message Match

- There's other distractions and no specific CTA.
- He's at the top of Google search, but attracting those with the least patience to search his site.
- Bob pays more per click because his homepage has a low quality score.

### Conversion Focused

- Includes a lower risk conversion option.
- Builds in urgency with FOMO.
- A tweaked landing page for each ad type.

## Mistakes Setting Up Ads
...
- You need to be responsive and have the budget.
- Most campaigns need 2-3 months of testing and optimization before hitting profitable ROI.
- Google Ads is not "set and forget".

## Hired Help

- Look for transparency and someone who can show examples of returns for clients similar you.
- Don't place too much faith in badges.
- A red flag is someone approaching you offering to get you more traffic.

## Checklist

- Have you optimized your on-site SEO?
- Have you optimized your Google Business profile?
- Have you checked Google's [Local Service Ads](https://business.google.com/us/ad-solutions/local-service-ads/)?
